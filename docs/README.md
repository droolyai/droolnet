# WokeNet documentation

The canonical map of this repository's documentation.
...
[`wokesocial`](https://github.com/AlexBTC420/wokesocial) repository.
Measured results live next to the code that produced them, in
